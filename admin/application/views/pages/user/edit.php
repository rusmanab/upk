    ...
    <!-- /.content -->
		...
		echo form_open('user/updatedata', $attr);
		?>
			<input type="hidden" name="id" value="<?php echo $pengguna->id?>" />
			<label>Nama</label>
			<input type="text" name="nama" value="<?php echo $pengguna->nama_lengkap?>" />   
			
			<label>Email</label>
			<input type="email" name="email" value="<?php echo $pengguna->email ?>" />
			<label>Phone</label>
			<input type="text" name="phone" value="<?php echo $pengguna->phone ?>" />
